...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('expedientes', function (Blueprint $table) {
            ...
            $table->integer('tiempo_cfi_area');
            $table->date('fecha_derivacion_tecnico');
            $table->integer('tiempo_area_tecnico');
            $table->date('fecha_elevacion_tdrs');
            $table->integer('tiempo_tecnico_elevacion_tdrs');
            $table->date('fecha_firma_direccion');
            $table->integer('tiempo_elevacion_firma');
            $table->string('gde_firma_direccion');
            $table->date('fecha_derivacion_gestion');
            $table->integer('tiempo_direccion_gestion');
            $table->date('fecha_inicio_contrato');
            $table->integer('tiempo_total_gestion');
            $table->integer('plazo');
