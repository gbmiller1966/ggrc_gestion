<x-layout>
    ...
    <thead class="bg-gray-100">
        <tr>
            ...
            <th class="w-1/2 px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Asignación</th>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        @foreach($asignaciones as $asignacion)
            <tr>
                <td class="w-1/4 px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $asignacion->id }}</td>
                <td class="w-1/2 px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $asignacion->asignacion }}</td>
                <td class="w-1/4 px-3 py-3 whitespace-nowrap text-sm text-gray-900">
                    <a href="/asignaciones/{{ $asignacion->id }}/edit">
