<x-layout>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        @foreach($direcciones as $direccion)
            <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $direccion->id }}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $direccion->direccion }}</td>
