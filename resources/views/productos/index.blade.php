    ...
    <tbody class="bg-white divide-y divide-gray-200">
        @foreach($productos as $producto)
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $producto->producto }}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $producto->precio }}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $producto->fecha }}</td>
