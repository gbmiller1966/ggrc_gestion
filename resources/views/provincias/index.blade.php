<x-layout>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        @foreach($provincias as $provincia)
            <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $provincia->id }}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $provincia->provincia }}</td>
