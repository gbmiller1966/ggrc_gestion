<x-layout>
    ...
    <thead class="bg-gray-100">
        <tr>
            <th class="w-1/4 px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">ID</th>
            <th class="w-2/4 px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Provincia</th>
            <th class="w-1/4 px-4 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider" colspan="2">Acciones</th>
        </tr>
    </thead>
    <tbody class="bg-white divide-y divide-gray-200">
        @foreach($provincias as $provincia)
            <tr>
                <td class="w-1/4 px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $provincia->id }}</td>
                <td class="w-2/4 px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $provincia->provincia }}</td>
