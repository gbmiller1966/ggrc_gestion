<x-layout>
    ...
    <thead class="bg-gray-100">
        <tr>
            ...
            <th class="w-1/2 px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Tema Estratégico</th>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        @foreach($temas as $tema)
            <tr>
                <td class="w-1/4 px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $tema->id }}</td>
                <td class="w-1/2 px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $tema->tema }}</td>
