...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Ingrese sus datos</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form action="/usuarios" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <div class="mt-2">
                <input id="usuario" type="text" name="usuario" required autocomplete="usuario" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
            </div>
        </div>
...
{{--             <div class="flex items-center justify-between">
        ...
        <div>
            <label for="password2" class="block text-sm/6 font-medium text-gray-900">Reingrese su password:</label>
            <div class="mt-2">
        ...
        <div>
            <select name="direccion_id" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                <option value="" class="block text-sm/6 font-medium text-gray-900">-- Seleccione su Dirección --</option>
        ...
        <div>
            <select name="area_id" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                <option value="" class="block text-sm/6 font-medium text-gray-900">-- Seleccione su Área --</option>
        ...
        <div class="grid grid-cols-2 gap-2">
            ...
            <button type="button" class="justify-center mt-1 rounded-md bg-red-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                <a href="/usuarios"><i class="bi bi-x-circle-fill"> Cancelar</i></a>
            </button>
        </div>
    </form>
  </div>
